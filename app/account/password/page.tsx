...
const inputCls = "w-full h-12 px-4 py-3 bg-white rounded-[10px] outline outline-[1.31px] outline-gray-200 text-neutral-700 text-sm font-normal font-['Montserrat'] focus:outline-sky-700 outline-none transition-colors";
  ...
  return (
    <div className="flex-1 bg-white rounded-xl shadow-sm flex flex-col">
      <div className="px-8 py-6 border-b border-gray-200 rounded-tl-2xl rounded-tr-3xl">
        <h2 className="text-zinc-900 text-2xl font-medium font-['Montserrat'] leading-7">Change your Password</h2>
      </div>

      <form onSubmit={handleSubmit} className="p-8 flex flex-col gap-6">
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-1">
            <label className="text-zinc-900 text-xs font-bold font-['Montserrat'] leading-5">Current Password</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-zinc-900 text-xs font-bold font-['Montserrat'] leading-5">New Password</label>
            <input type="password" value={form.newPass} onChange={set('newPass')} placeholder="Enter New Password" required className={inputCls} />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-zinc-900 text-xs font-bold font-['Montserrat'] leading-5">Confirm New Password</label>
          ...
          <div className="p-4 bg-sky-700/10 rounded-lg outline outline-1 outline-sky-700/50 flex flex-col gap-2">
            <span className="text-sky-700 text-sm font-medium font-['Montserrat'] leading-5">Password Requirements:</span>
            <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-6">
            <button type="button" onClick={reset}
              className="w-36 p-4 rounded-xl outline outline-1 outline-sky-700 text-sky-700 text-base font-medium font-['Montserrat'] hover:bg-sky-50 transition-colors">
              Cancel
            </button>
            <button type="submit" disabled={status === 'loading'}
              className="px-6 p-4 bg-sky-700 rounded-xl text-white text-base font-medium font-['Montserrat'] hover:bg-sky-800 transition-colors disabled:opacity-60">
