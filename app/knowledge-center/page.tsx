  ...
  return (
    <main className="w-full bg-white flex flex-col">
      <div className="w-full px-4 md:px-0 pt-10 md:pt-20 pb-8 md:pb-10 bg-stone-50 flex flex-col items-center gap-4 md:gap-6">
        <h1 className="text-sky-700 text-2xl md:text-3xl font-bold font-['Montserrat'] text-center px-4">
          Understand Power. Make Better Decisions.
        </h1>
        <p className="max-w-[531px] text-center text-sky-700 text-base md:text-lg font-normal font-['Montserrat'] px-4">
