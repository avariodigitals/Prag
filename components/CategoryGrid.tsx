      ...
      <div className="w-full max-w-[1280px] flex flex-col gap-10">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-4">
          {categories.map((cat) => (
            ...
            >
              <Image src={cat.image} alt={cat.name} fill sizes="(min-width: 1024px) 25vw, (min-width: 768px) 50vw, 100vw" quality={80} loading="lazy" className="object-contain group-hover:scale-105 transition-transform duration-300 p-6" />
