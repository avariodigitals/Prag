    ...
    <footer className="w-full px-4 md:px-20 py-10 bg-slate-950 flex flex-col justify-center items-center gap-10 overflow-hidden"> 
        ...
        <div className="w-full lg:w-96 flex flex-col justify-start items-start gap-4"> 
          ...
          <div className="w-full max-w-52 flex flex-col justify-start items-start gap-2"> 
            <div className="w-full flex justify-start items-center gap-4"> 
              ...
              <a href={`tel:${phone}`} className="text-white/70 text-base font-normal font-['Space_Grotesk'] leading-7 hover:text-white transition-colors">{formatPhone(phone)}</a> 
            </div> 
            <div className="flex justify-start items-center gap-4"> 
              ...
              <a href={`mailto:${email}`} className="text-white/70 text-base font-normal font-['Space_Grotesk'] leading-7 underline hover:text-white transition-colors">
                {email}
              </a> 
            </div> 
          </div> 
      ...
      <div className="w-full max-w-[1228px] flex flex-col justify-start items-start gap-4"> 
        ...
        <div className="w-full flex flex-col justify-center items-center gap-3"> 
          <div className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7 text-center">© Copyright {new Date().getFullYear()} PRAG. All rights reserved.</div> 
          <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-2"> 
            <Link href="/privacy" className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7 py-1.5 hover:text-white transition-colors">Privacy</Link> 
            <div className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7">|</div> 
            <Link href="/terms-of-use" className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7 py-1.5 hover:text-white transition-colors">Terms of use</Link> 
            <div className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7">|</div> 
            <Link href="/sitemap" className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7 py-1.5 hover:text-white transition-colors">Sitemap</Link>
            <div className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7">|</div>
            <a href="#" id="open_preferences_center" className="text-white/70 text-sm md:text-base font-normal font-['Space_Grotesk'] leading-7 py-1.5 hover:text-white transition-colors">Update cookies preferences</a>
          </div> 
        </div> 
      </div> 
    </footer>
