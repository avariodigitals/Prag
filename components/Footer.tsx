        ...
        <div className="w-full lg:w-96 flex flex-col justify-start items-start gap-4"> 
          ...
          <div className="w-full max-w-52 flex flex-col justify-start items-start gap-2"> 
            <div className="w-full flex justify-start items-center gap-4"> 
              ...
              <a href="tel:+2348032170129" className="text-white/70 text-sm font-normal font-['Space_Grotesk'] hover:text-white transition-colors">+2348032170129</a> 
            </div> 
            <div className="flex justify-start items-center gap-4"> 
              ...
              <a href="mailto:sales@prag.global" className="text-white/70 text-sm font-normal font-['Space_Grotesk'] underline hover:text-white transition-colors">
                sales@prag.global
              </a> 
            </div> 
          </div> 
