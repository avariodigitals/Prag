        ...
        <div className="w-full lg:w-96 flex flex-col justify-start items-start gap-4"> 
          ...
          <div className="w-full max-w-52 flex flex-col justify-start items-start gap-2"> 
            <div className="w-full flex justify-start items-center gap-4"> 
              ...
              <a href={`tel:${phone}`} className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">{phone}</a> 
            </div> 
            <div className="flex justify-start items-center gap-4"> 
              ...
              <a href={`mailto:${email}`} className="text-white/70 text-base font-normal font-['Space_Grotesk'] underline hover:text-white transition-colors">
                {email}
              </a> 
            </div> 
          </div> 
        ...
        <div className="w-full lg:w-[724px] grid grid-cols-2 md:grid-cols-4 gap-8 lg:flex lg:justify-between lg:items-start"> 
          <div className="flex flex-col justify-start items-start gap-4"> 
            ...
            <div className="flex flex-col justify-start items-start gap-1.5">
              <Link href="/products/batteries" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Batteries</Link>
              <Link href="/products/voltage-stabilizers" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Stabilizers</Link>
              <Link href="/products/inverters" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Inverter</Link>
              <Link href="/products/solar" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Solar</Link>
            </div> 
          </div> 
          <div className="flex flex-col justify-start items-start gap-4"> 
            <div className="text-white text-base font-bold font-['Space_Grotesk']">Company</div>
            <div className="flex flex-col justify-start items-start gap-1.5">
              <Link href="/about" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">About us</Link>
              <Link href="/stores" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">PRAG Stores</Link>
              <Link href="/knowledge-center" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Knowledge Center</Link>
              <Link href="/distributor" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Become a Distributor</Link>
            </div> 
          </div> 
          <div className="flex flex-col justify-start items-start gap-4"> 
          ...
          <div className="flex flex-col justify-start items-start gap-4"> 
            ...
            <div className="flex flex-col justify-start items-start gap-1.5">
              {socials.facebook && <a href={socials.facebook} target="_blank" rel="noopener noreferrer" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Facebook</a>}
              {socials.instagram && <a href={socials.instagram} target="_blank" rel="noopener noreferrer" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Instagram</a>}
              {socials.linkedin && <a href={socials.linkedin} target="_blank" rel="noopener noreferrer" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">LinkedIn</a>}
              {socials.twitter && <a href={socials.twitter} target="_blank" rel="noopener noreferrer" className="text-white/70 text-base font-normal font-['Space_Grotesk'] hover:text-white transition-colors">Twitter / X</a>}
            </div> 
          </div> 
        </div> 
      </div> 
