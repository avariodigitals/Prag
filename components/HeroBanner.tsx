        ...
        <div className="flex-1 flex flex-col gap-8 md:gap-10 items-center md:items-start text-center md:text-left">
          <div className="flex flex-col gap-4 md:gap-6">
            ...
            <div className="flex justify-center md:justify-start">
              <Link href={slide.link} className="w-64 md:w-auto px-6 py-3 bg-sky-700 rounded-3xl md:rounded-full flex justify-center items-center gap-2.5 hover:bg-sky-800 transition-all hover:scale-105">
                <span className="text-white text-sm font-medium font-['Space_Grotesk'] whitespace-nowrap">{slide.cta}</span>
              </Link>
            </div>
          </div>
