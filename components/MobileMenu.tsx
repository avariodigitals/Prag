        ...
        <div className="p-4 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            {NAV_CATEGORIES.map(({ label, href }) => (
              <Link
                ...
                href={href}
                onClick={onClose}
                className="self-stretch p-4 rounded-[10px] text-neutral-700/70 text-sm font-bold font-['Montserrat'] hover:bg-stone-50 transition-colors"
              >
                {label}
              </Link>
            ))}
          ...
          <div className="pt-3 border-t border-black/10 flex flex-col gap-2">
            ...
            >
              ...
              <span className="text-neutral-700/70 text-sm font-bold font-['Montserrat']">Saved items</span>
            </Link>
            ...
            >
              ...
              <span className="text-neutral-700/70 text-sm font-bold font-['Montserrat']">Cart</span>
            </Link>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-neutral-700/70 text-sm font-bold font-['Montserrat']">Hotline</span>
                <span className="text-neutral-700/70 text-base md:text-lg font-medium font-['Montserrat']">+2348032170129</span>
              </div>
            </a>
            ...
            >
              ...
              <span className="text-neutral-700/70 text-base font-medium font-['Montserrat'] leading-4">Login or Register</span>
            </Link>
          </div>
        </div>
      </div>
