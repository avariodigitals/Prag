    ...
    <div className="w-full px-4 md:px-20 pt-8 md:pt-12 pb-12 md:pb-16">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-5 md:gap-6 max-w-[620px]">
          ...
          <div className="flex gap-4">
            <button onClick={handleAddToCart} disabled={adding || addedToCart || isOutOfStock}
              className="flex-1 h-11 px-4 rounded-3xl outline outline-1 outline-sky-700 flex justify-center items-center gap-2 hover:bg-sky-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
              {adding ? (
          ...
          <a href={`https://wa.me/2348032170129?text=${encodeURIComponent(`Hi, I'm interested in the ${product.name}. ${pageUrl}`)}`}
            ...
            className="w-full h-11 px-4 bg-sky-700 rounded-3xl flex justify-center items-center gap-2 hover:bg-sky-800 transition-colors">
      ...
      {relatedProducts.length > 0 && (
        <div className="flex flex-col gap-6">
          <h2 className="text-neutral-700 text-lg md:text-2xl font-semibold font-['Montserrat']">Related Products</h2>
