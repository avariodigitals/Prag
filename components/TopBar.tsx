    ...
    <>
      ...
      <div className="hidden md:flex w-full px-20 py-5 bg-white justify-between items-center">
        <Link href="/" aria-label="PRAG home" className="shrink-0">
          <Image src="/Prag Logo.png" alt="PRAG" width={140} height={40} priority />
        </Link>
        ...
        <div className="inline-flex items-center gap-6">
          <a href={`https://wa.me/${whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="py-2.5 flex items-center gap-1">
            <svg className="w-9 h-9 text-neutral-700" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-28 flex flex-col">
              <span className="text-neutral-700 text-sm font-bold font-['Space_Grotesk']">Hotline</span>
              <span className="text-neutral-700 text-sm font-medium font-['Space_Grotesk']">{phone}</span>
            </div>
          </a>
      ...
      <div className="md:hidden sticky top-0 z-50 w-full bg-white/95 backdrop-blur-sm shadow-[0_1px_0_rgba(15,23,42,0.08)]">
        <div className="w-full px-4 h-[78px] bg-white flex items-center justify-between gap-4">
          <Link href="/" aria-label="PRAG home" className="shrink-0">
            <Image src="/Prag Logo.png" alt="PRAG" width={150} height={44} priority />
          </Link>
