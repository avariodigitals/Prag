        ...
        <div className="inline-flex items-center gap-6">
          <a href={`https://wa.me/${whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="py-2.5 flex items-center gap-1">
            ...
            <div className="w-28 flex flex-col">
              ...
              <span className="text-neutral-700/70 text-sm font-medium font-['Space_Grotesk']">{phone}</span>
            </div>
          </a>
      ...
      <div className="md:hidden sticky top-0 z-50 w-full bg-white/95 backdrop-blur-sm shadow-[0_1px_0_rgba(15,23,42,0.08)]">
        <div className="w-full px-4 h-[78px] bg-white flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link href="/wishlist" aria-label="Wishlist" className="w-10 h-10 flex items-center justify-center rounded-full active:bg-black/5 transition-colors">
            ...
            <Link href="/cart" aria-label="Cart" className="relative w-10 h-10 flex items-center justify-center rounded-full active:bg-black/5 transition-colors">
            ...
            <Link href={user ? '/account' : '/login'} aria-label="Account" className="w-10 h-10 flex items-center justify-center rounded-full active:bg-black/5 transition-colors">
              <svg className="w-6 h-6 text-neutral-700/75" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="10" />
                <circle cx="12" cy="8" r="3" />
                <path d="M6.168 18.849A4 4 0 0 1 10 16h4a4 4 0 0 1 3.832 2.849" />
        ...
        <div className="w-full px-4 py-3 bg-sky-700 flex items-center gap-3">
          <button onClick={() => setMenuOpen(true)} aria-label="Open menu" className="shrink-0 w-11 h-11 flex items-center justify-center rounded-lg active:bg-white/10 transition-colors">
