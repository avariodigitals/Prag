            ...
            <div className="w-[280px] overflow-hidden rounded-2xl border border-emerald-100 bg-white/95 shadow-2xl backdrop-blur">
              <div className="bg-gradient-to-br from-[#25D366] to-[#12B76A] px-4 py-3 text-white flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-sm font-semibold font-'['Space_Grotesk']' truncate">Chat with PRAG</p>
                  <p className="mt-0.5 text-xs text-white/85 font-'['Space_Grotesk']' line-clamp-2">We typically reply within a few minutes.</p>
                </div>
                <button
                  type="button"
              ...
              <div className="px-3 pt-3 pb-3">
                <p className="px-1 pb-2 text-[11px] font-semibold tracking-wide uppercase text-zinc-500 font-'['Space_Grotesk']'">Choose an option</p>
                <div className="flex flex-col gap-2">
                  {WHATSAPP_QUICK_ACTIONS.map((action) => (
                    ...
                    >
                      <div className="min-w-0">
                        <p className="text-sm font-semibold text-zinc-900 font-'['Space_Grotesk']' truncate">{action.label}</p>
                        {action.subtitle && <p className="mt-0.5 text-xs text-zinc-600 font-'['Space_Grotesk']' truncate">{action.subtitle}</p>}
                      </div>
                    </button>
                  ))}
                </div>
                ...
                <button
                  ...
                  className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-br from-[#25D366] to-[#12B76A] text-white px-4 py-2.5 text-sm font-semibold shadow-lg shadow-emerald-200/50 transition-transform duration-200 hover:scale-[1.02] font-'['Space_Grotesk']'"
                >
