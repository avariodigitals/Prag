    ...
    <>
      ...
      {isWhatsappEnabled && whatsappHref && (
        <a
          ...
          title={whatsappText}
          className="fixed bottom-24 right-4 z-[80] inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-[1.06] hover:bg-[#1ebe5d] md:bottom-24 md:right-6 md:h-16 md:w-16"
        >
